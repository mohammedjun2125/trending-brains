...
const itProgramSlugs = ["data-analytics-course", "data-science-course", "artificial-intelligence-machine-learning", "cyber-security-course", "python-full-stack-development"];
